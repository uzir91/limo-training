#include "limo_bringup/limo_bringup_node.hpp"
...
void LimoSystemHardware::stateCallback(
...
void LimoSystemHardware::timerCallback(
...
hardware_interface::CallbackReturn LimoSystemHardware::on_init(
    const hardware_interface::HardwareInfo & info)
{
    ...
    logger_ = std::make_shared<rclcpp::Logger>(rclcpp::get_logger("limo_bringup.LimoSystemHardware"));
    clock_ = std::make_shared<rclcpp::Clock>(rclcpp::Clock());

    node_ = rclcpp::Node::make_shared("limo_bringup_node");
...
LimoSystemHardware::export_state_interfaces()
{
...
LimoSystemHardware::export_command_interfaces()
{
...
hardware_interface::CallbackReturn LimoSystemHardware::on_activate(
    const rclcpp_lifecycle::State & /*previous_state*/)
{
    RCLCPP_INFO(get_logger(), "Activating LimoSystemHardware ...");
...
hardware_interface::CallbackReturn LimoSystemHardware::on_deactivate(
    const rclcpp_lifecycle::State & /*previous_state*/)
{
    RCLCPP_INFO(get_logger(), "Deactivating LimoSystemHardware ...");
...
hardware_interface::return_type LimoSystemHardware::read(
...
hardware_interface::return_type LimoSystemHardware::write(
    const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
PLUGINLIB_EXPORT_CLASS(
    limo_bringup::LimoSystemHardware, hardware_interface::SystemInterface)
