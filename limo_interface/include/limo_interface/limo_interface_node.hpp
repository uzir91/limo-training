...
#ifndef LIMO_INTERFACE__LIMO_INTERFACE_NODE_HPP_
#define LIMO_INTERFACE__LIMO_INTERFACE_NODE_HPP_
...
namespace limo_interface
{
    ...
    class LimoSystem : public hardware_interface::SystemInterface
    {
        public:
            RCLCPP_SHARED_PTR_DEFINITIONS(LimoSystem)
...
#endif  // LIMO_INTERFACE__LIMO_INTERFACE_NODE_HPP_
